...
bedrock.events.on('bedrock.init', function() {
  scheduler.define('bedrock-messages.jobs.batchMessages', function(job, callback) {
...
api._batchMessageUpdateMessage = function(batch, message, done, results, callback) {
  batchMessageUpdateMessage(batch, message, done, results, callback);
};
api._batchMessageRemoveFromMap = function(batch, message, done, results, callback) {
